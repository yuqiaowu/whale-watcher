          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span className="text-[#E8E8E8]">_</span>
                <span className="inline-block text-[#E8E8E8]">DATA</span>
              </div>
            ...
            <nav className="flex items-center gap-8">
              {[t.nav.liquidity, t.nav.aiCopyTrading, t.nav.buyMeTea].map((item, index) => {
                ...
                return (
                  ...
                  >
                    {item}
                    <span className={`absolute bottom-0 left-0 h-0.5 bg-[#39FF14] transition-all duration-300 shadow-[0_0_5px_rgba(57,255,20,0.6)] ${
                      isActive
                        ? 'w-full' 
